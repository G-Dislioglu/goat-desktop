...
- **Run F:** LiveTalk. Mikrofon, STT, TTS. Half-Duplex. Mock-Schale ist code-ready. Windows-Audio-Probe fuer Aufnahme + SAPI-Ausgabe ist erledigt. Desktop-seitiger Builder-STT-Proxy ist code-ready, aber echter Soulmatch-STT-Acceptance fehlt weiter; deshalb nicht `completed`.
