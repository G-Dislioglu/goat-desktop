...
- **Run F:** LiveTalk. Mikrofon, STT, TTS. Half-Duplex. Mock-Schale ist code-ready. Windows-Audio-Probe fuer Aufnahme + SAPI-Ausgabe ist erledigt. Desktop-seitiger Builder-STT-Proxy ist code-ready. Live Builder-STT-Smoke mit synthetischer WAV ist erfolgreich; finale Live-Mikrofon-Acceptance fehlt weiter, deshalb nicht `completed`.
