...
- **Run F:** LiveTalk. Mikrofon, STT, TTS. Half-Duplex. Mock-Schale ist code-ready. Windows-Audio-Probe fuer Aufnahme + SAPI-Ausgabe ist erledigt, aber SAPI ist nur Fallback. Desktop-seitiger Builder-STT-Proxy ist code-ready und Live Builder-STT-Smoke mit synthetischer WAV ist erfolgreich. Desktop-seitiger Builder-TTS-Proxy ist code-ready, aber /api/goat/tts fehlt noch live; finale Live-Mikrofon-Acceptance fehlt weiter, deshalb nicht `completed`.
